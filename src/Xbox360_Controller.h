...
#ifndef REGGIE2_XBOX360_CONTROLLER_H_
#define REGGIE2_XBOX360_CONTROLLER_H_
#include "WPILib.h"
#include "Joystick.h"
#include <map>
...
public:
	...
	XBOX360_Controller(const char *name, uint32_t port, uint32_t numAxisTypes, uint32_t numButtonTypes);
...
#endif /* REGGIE2_XBOX360_CONTROLLER_H_ */
