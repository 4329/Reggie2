...
XBOX360_Controller::XBOX360_Controller(const char *name, uint32_t port) :
		Joystick(port,8,10)
{
	printf("Entering xbox360 Constructor\n");
	m_Name = name;
	m_Port = port;
	...
	printf("Exiting xbox360 Constructor\n");

}

XBOX360_Controller::XBOX360_Controller(const char *name, uint32_t port, uint32_t numAxisTypes, uint32_t numButtonTypes) :
